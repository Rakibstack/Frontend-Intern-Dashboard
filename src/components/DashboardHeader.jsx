    ...
    return (
        <div className='flex justify-between  items-center p-2'>
            ...
            <div className='flex'>
                ...
                <button className="text-[#1F7A57] border-2 bg-white font-medium border-[#1F7A57] px-6 py-3 rounded-4xl hover:text-white hover:bg-[#0F3D2E] duration-150 transition-all cursor-pointer">Import Data</button>
            </div>
