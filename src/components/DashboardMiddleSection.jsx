  ...
  return (
    <div className="grid grid-cols-12 mt-3  gap-6">
      ...
      <div className="col-span-12 lg:col-span-3 bg-white rounded-2xl p-5 shadow-sm flex flex-col justify-between">
        ...
        <button className="mt-6 bg-[#1F7A57] hover:bg-[#0F3D2E] text-white py-3 rounded-xl font-semibold transition">
          Start Meeting
        </button>
      </div>
      ...
      <div className="col-span-12 lg:col-span-3 bg-white rounded-2xl p-6 shadow-sm">
        <div className="flex items-center justify-between mb-5">
          ...
          <button className="text-sm px-3 py-1 rounded-lg border border-gray-200 hover:bg-gray-100">
            + New
          </button>
        </div>
